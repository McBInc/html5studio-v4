...
const article = {
  ...
  body: ({ IntelligenceNote, DataTable, CodeBlock }) => (
    <>
      ...
      <p className="text-foreground/80 leading-relaxed mb-4">
        The smart contract model eliminates trust as a variable. The blockchain IS the revenue report. Every transaction is public, immutable, and settled in seconds.
      </p>
...
() recv_internal(int msg_value, cell in_msg_full, slice in_msg_body) impure {
    ...
    ;; All three execute in the same TON block — atomic, irrevocable
      ...
      <h2 className="text-2xl font-bold mt-10 mb-4">The HTML5STUDIO Ambassador Program Structure</h2>
      <p className="text-foreground/80 leading-relaxed mb-4">
