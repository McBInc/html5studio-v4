...
const article = {
  ...
  relatedSiblings: [
    { slug: "APIDeprecationTracker", title: "API Deprecation Tracker", urgency: "hot" },
    { slug: "MetaSDKMigration", title: "Meta SDK v8.0 Migration Guide", urgency: "critical" },
    { slug: "UnityWebGLBuildTroubleshooting", title: "Build Troubleshooting & Fixes", urgency: "critical" },
  ],
  relatedCrossPillar: [
    { slug: "WebGLCertificationStandard", title: "WebGL Certification Standard (WGL-CERT)" },
    { slug: "PlatformAPIChangeAlerts", title: "Platform API Change Alerts" },
    { slug: "EUDMAArticle7", title: "EU DMA Article 7 Interoperability" },
  ],
  faqs: [
    {
